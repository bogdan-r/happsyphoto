...
module.exports = function(grunt) {
    ...
    devAdminTpl: {
      options: {
        startTag: '<!--TEMPLATES ADMIN-->',
        endTag: '<!--TEMPLATES ADMIN END-->',
        fileTmpl: '<script type="text/javascript" src="%s"></script>',
        appRoot: '.tmp/public'
      },
      files: {
        '.tmp/public/index.html': ['.tmp/public/jstAdmin.js'],
        'views/**/*.html': ['.tmp/public/jstAdmin.js'],
        'views/**/*.ejs': ['.tmp/public/jstAdmin.js']
      }
    },
